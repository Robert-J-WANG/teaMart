...
namespace teaMart.Controllers
{
    public class AdminController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            DateTime startOfWeek = dateTime.AddDays(1 - Convert.ToInt32(dateTime.DayOfWeek.ToString("d"))).Date; // 周一
            DateTime endOfWeek = startOfWeek.AddDays(7); // 下周一
            ViewBag.startOfWeek = startOfWeek; // 本周开始时间
            ViewBag.endOfWeek = endOfWeek.AddDays(-1); // 本周结束时间（周日）
